...
tacq = 3000 # Measurement time in millisec, you can change this
...
outputfile = open('tttrmode1.ptu', "wb+")
...
while True:
    ...
    if nactual.value > 0:
        ...
        if ctcDone.value > 0: 
            ...
            # from PicoHarp_demo32.PH_only_PTU import PH_PTU_to_data
            # import matplotlib.pyplot as plt
            # x = PH_PTU_to_data()
            # data_for_plot = x.Process(temp, Resolution=256)
