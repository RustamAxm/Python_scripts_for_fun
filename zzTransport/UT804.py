...
class UT804:
    ...
    def __init__(self):
        ...
        self.main_dict = {
            ...
            '3': {'0': [3, 'mV']},  # DC mV
            '4': {'1': [3, 'Ohm'], '2': [1, 'kOhm'], '3': [2, 'kOhm'], '4': [3, 'kOhm'], '5': [1, 'MOhm'], '6': [2, 'MOhm']},
        ...
        self.ACDC_dict = {'0': ' ', '1': ' AC TrueRMS', '3': 'AC+DC TrueRMS'}
        self.sign = {
            '0': ' ',
            '1': ' ',
            '2': ' ',
    ...
    def read(self):
        output = []
        while True:
            answer = self.ep.read(self.ep.wMaxPacketSize)
            if answer[0] == 241:
                    ...
                    if values[3] == '12':
                        ...
                        if flags[1] != '12':
                            ...
                            if flags[3] != '5':
                                ...
                                self.value = ' ' + ''.join(values)[:dot_pos] + '.' + \
                                    ''.join(values)[dot_pos:]
                    return self.value, self.unit, self.ACDC
